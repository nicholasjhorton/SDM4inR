---
title: "SDM4 in R: Stats Starts Here (Chapter 2)"
...
options(digits=3)
Tour <- read.delim("data/Tour_de_France_2014.txt", sep="\t", stringsAsFactors=FALSE)
# Tour <- read_delim("http://www.amherst.edu/~nhorton/sdm4/data/Tour_de_France_2014.txt", delim="\t")
head(Tour, 3)
tail(Tour, 8)
```
