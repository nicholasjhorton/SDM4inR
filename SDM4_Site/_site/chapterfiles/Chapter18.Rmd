...
### Section 18.2: Interpreting confidence intervals for a proportion

```{r warning = FALSE}
set.seed(1988)
CIsim(n = 156, samples = 20, rdist = rbinom, 
  args=list(size=1, prob=.7), estimand = .7, method = binom.test)
```

We would expect 19 out of 20 of the intervals to cover the true (population) value, but here only 18 out of 20 actually covered that value (see similar Figure at the top of page 476).
